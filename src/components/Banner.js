  ...
  return (
    <div>
      ...
      >
        <SwiperSlide>
           <div
      className="bg-cover bg-no-repeat bg-center h-[77vh] lg:h-[65vh] justify-center items-center pt-48"
      style={{
    ...
    >
      <div className="container">
        ...
        <div className="mt-12 ">
         ...
         <SwiperSlide className="bg-cover bg-no-repeat bg-center lg:pr-20 pr-0 pl-0 lg:pl-36 justify-center items-center"
      style={{
      ...
      >
          <div className="flex flex-col lg:flex-row justify-between items-center h-[77vh] lg:h-[65vh]" >
              <div>
        ...
        <SwiperSlide className="bg-black">
          <div className="flex flex-col lg:flex-row item-center justify-between lg:px-48 lg:h-[65vh] h-[77vh] overflow-hidden">
            ...
            <div>
              <img className="lg:h-[65vh] h-[50vh] ml-12 lg:ml-0 mb-7 relative lg:mt-5" src='https://www.techspot.com/images2/news/bigimage/2019/11/2019-11-20-image-30.jpg' />
            </div>
