        ...
        <div className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" className="input-box" placeholder="Enter first name" value={user.name} />
            </div>
            <div>
              <label htmlFor="full-name" className="text-gray-600 mb-2 block">
                Last Name
              </label>
              <input type="text" className="input-box" placeholder="Enter last name" value={user.name} />
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" className="input-box" placeholder="Enter email address" value={user.email} />
            </div>
            <div>
              <label htmlFor="full-name" className="text-gray-600 mb-2 block">
                Phone Number
